  ...
  Future<void> fetchEditData() async {
    ...
    try {
      final response = await http.post(
        Uri.parse("https://gst.billcare.in/api/expense/edit"),
        headers: {"Authorization": "Bearer $authToken"},
        body: {"ExpenseId": widget.expenseId.toString()},
      );
  ...
  Future<void> updateExpense() async {
    try {
      var request = http.MultipartRequest(
        "POST",
        Uri.parse("https://gst.billcare.in/api/expense/update"),
      );

      request.headers["Authorization"] = "Bearer $authToken";

      request.fields["ExpenseId"] = widget.expenseId.toString();
 ...
 Future<void> loadToken() async {
  ...
  Future<void> saveExpense() async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
        "POST",
        Uri.parse("https://gst.billcare.in/api/expense/store"),
      );
  ...
  Future<void> fetchItems() async {
    try {
      ...
      print("Item Response: ${response.body}"); // <-- debug
      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
                        ...
                        children: [
                                ...
                                child: _dropdown(
                                  ...
                                  (v) {
                                    setState(() {
                                      ...
                                      items[index]["priceCtrl"].text = price;
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                flex: 2,
                                child: _field("Qty", items[index]["qtyCtrl"], (
                                  v,
                                ) {
                                  items[index]["qty"] = v;
                                  _recalculate(index);
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(isEditMode ? "Update Expense" : "Save Expense"),
                ),
              ),
            ),
          ],
