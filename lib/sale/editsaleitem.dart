...
class EditSaleItemsPage extends StatefulWidget {
  final int saleId;
  final List<Map<String, dynamic>> initialItems;
  final String pageTitle;

  const EditSaleItemsPage({
    super.key,
    required this.saleId,
    required this.initialItems,
    this.pageTitle = "Edit Items in Sale",
  });

  @override
  State<EditSaleItemsPage> createState() => _EditSaleItemsPageState();
}

class _EditSaleItemsPageState extends State<EditSaleItemsPage> {
